...
for epoch in range(num_epochs):
    ...
    if epoch % 500 == 0:
        torch.save(netG.state_dict(), 'generator_weights_'+str(epoch)+'.pth')
        torch.save(netD.state_dict(), 'discriminator_weights_'+str(epoch)+'.pth')

    iters += 1

torch.save(netG.state_dict(), 'generator_weights_final.pth')
torch.save(netD.state_dict(), 'discriminator_weights_final.pth')
